...
{
    /// <inheritdoc />
    public partial class InitialIdentityDbContextSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdoptionPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsCastrated = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Coat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Size = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsAffectionate = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Adoptions_Clients_ClientId",
                        column: x => x.ClientId,
